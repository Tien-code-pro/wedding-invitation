        ...
        <p className="mt-12 font-serif italic text-[#999] text-sm">
          ...
          <div className="relative w-full max-w-4xl mx-auto px-4 mb-20 mt-20">
              ...
              <div className="relative h-[450px] md:h-[550px] w-full flex justify-center items-end">
                  ...
                  {/* 2 ẢNH PHÍA SAU */}
                  <div className="absolute top-0 left-[5%] w-[40%] aspect-[3/4] z-0 transition-all duration-500 ease-in-out hover:z-20 hover:scale-110 group"
                  ...
                  <div className="absolute top-0 right-[5%] w-[40%] aspect-[3/4] z-0 transition-all duration-500 ease-in-out hover:z-20 hover:scale-110 group"
                  ...
                  <div className="absolute bottom-[-40px] left-1/2 -translate-x-1/2 w-[45%] aspect-[3/4] z-10 transition-all duration-500 ease-in-out hover:z-20 hover:scale-110 hover:bottom-0"
              ...
              <div className="mt-20 flex flex-col items-end pr-4 md:pr-12">
                  <div className="text-right">
                      ...
                      <h3 className="text-3xl md:text-5xl text-gray-800 mt-2"
